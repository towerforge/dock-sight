...
import OverviewPage from '@/pages/service/detail/overview/overview-page'
import ContainersPage from '@/pages/service/detail/containers/containers-page'
import ImagesPage from '@/pages/service/detail/images/images-page'
import LogsPage from '@/pages/service/detail/log/logs-page'
import MetricsPage from '@/pages/service/detail/metrics/metrics-page'
